...
// ─── Merge JSON-defined routines into pools ─────────────────────
// Loads everything in assets/dataset/Routines.json once at module init and
// merges the entries into the existing pools, deduped by lowercased title.
(function mergeJsonRoutines() {
